...
SECRET_KEY = '!&lpe0_!qsc0l71p%nfec!h0qi@l%0ju-#7_94eaq8_e(vsr7#'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permission.DjangoModelPermissionOrAnonReadOnlys'
    ]
}
...
AUTH_USER_MODEL =  'signup.UserData'
